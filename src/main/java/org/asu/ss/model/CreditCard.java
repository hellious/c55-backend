...
public class CreditCard {
	...
	public CreditCard(long acc_no, long card_no, int cvv, Date issue_date, Date expiry_date, String card_name,
			String cardtype, double credit_limit, double amount_used, float interest_rate, double amount_spent) {
		super();
		this.acc_no = acc_no;
		this.card_no = card_no;
		this.cvv = cvv;
