  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
      ...
      <body>
		...
		<form id="InternalEmployeeAddition" role="form" class="form-horizontal" onsubmit="return makeJson()">
			<fieldset>
				<div class="form-group">
					<label for="Branch Name">Branch Name:</label>
					<input type="text" class="form-control" id="branchname" placeholder="Enter Branch">
				</div>
			</fieldset>
			<div class="form-group">
					...
					<select class="form-control" id="nationality">
						...
						<option value="Regular Employee" title="Regular Employee">Regular Employee</option>
			...
			<fieldset>
				...
				<div class="form-group">
      				<div class="col-sm-6"><label>First name</label><input class="form-control" placeholder="First Name" type="text"></div>
      				<div class="col-sm-6"><label>Last name</label><input class="form-control" placeholder="Last Name" type="text"></div>
    			
    			</div>
				
				<div class="form-group">
					<label>Date of Birth</label>
					<input class="form-control" id="dob" placeholder="Date of Birth" type="date">
				</div>
